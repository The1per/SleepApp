...
def _gauge(ax, val: float, lang="en", vmin=0, vmax=30):
    ...
    ax.text(0, -0.28, _t("events / hour", lang), ha="center", va="center", fontsize=11, fontweight="bold", color=TEXT_L, zorder=8, fontproperties=_he_fp(bold=True) if lang == "he" else None)
